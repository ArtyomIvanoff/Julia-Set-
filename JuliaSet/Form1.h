...
namespace JuliaSet {
	...
	private: System::Windows::Forms::NumericUpDown^  numericUD_A;
	private: System::Windows::Forms::NumericUpDown^  numericUD_B;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->numericUD_B = (gcnew System::Windows::Forms::NumericUpDown());
			this->numericUD_A = (gcnew System::Windows::Forms::NumericUpDown());
			this->labelKoeff = (gcnew System::Windows::Forms::Label());
			...
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->numericUD_B))->BeginInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->numericUD_A))->BeginInit();
			...
			// butPrint
			// 
			this->butPrint->Location = System::Drawing::Point(19, 273);
			...
			this->numIters->Maximum = System::Decimal(gcnew cli::array< System::Int32 >(4) {200000, 0, 0, 0});
			this->numIters->Minimum = System::Decimal(gcnew cli::array< System::Int32 >(4) {20, 0, 0, 0});
			this->numIters->Name = L"numIters";
			this->numIters->Size = System::Drawing::Size(78, 20);
			this->numIters->TabIndex = 0;
			this->numIters->Value = System::Decimal(gcnew cli::array< System::Int32 >(4) {20, 0, 0, 0});
			this->numIters->ValueChanged += gcnew System::EventHandler(this, &Form1::numIters_ValueChanged);
			// 
			// panel2
			// 
			this->panel2->Controls->Add(this->numericUD_B);
			this->panel2->Controls->Add(this->numericUD_A);
			this->panel2->Controls->Add(this->labelKoeff);
			...
			this->panel2->Location = System::Drawing::Point(748, 28);
			this->panel2->Name = L"panel2";
			this->panel2->Size = System::Drawing::Size(353, 719);
			this->panel2->TabIndex = 2;
			// 
			// numericUD_B
			// 
			this->numericUD_B->DecimalPlaces = 15;
			this->numericUD_B->Increment = System::Decimal(gcnew cli::array< System::Int32 >(4) {1, 0, 0, 983040});
			this->numericUD_B->Location = System::Drawing::Point(192, 192);
			this->numericUD_B->Maximum = System::Decimal(gcnew cli::array< System::Int32 >(4) {2, 0, 0, 0});
			this->numericUD_B->Minimum = System::Decimal(gcnew cli::array< System::Int32 >(4) {2, 0, 0, System::Int32::MinValue});
			this->numericUD_B->Name = L"numericUD_B";
			this->numericUD_B->Size = System::Drawing::Size(130, 20);
			this->numericUD_B->TabIndex = 12;
			this->numericUD_B->Value = System::Decimal(gcnew cli::array< System::Int32 >(4) {74, 0, 0, -2147352576});
			this->numericUD_B->ValueChanged += gcnew System::EventHandler(this, &Form1::numericUD_B_ValueChanged);
			// 
			// numericUD_A
			// 
			this->numericUD_A->DecimalPlaces = 15;
			this->numericUD_A->Increment = System::Decimal(gcnew cli::array< System::Int32 >(4) {1, 0, 0, 983040});
			this->numericUD_A->Location = System::Drawing::Point(20, 192);
			this->numericUD_A->Maximum = System::Decimal(gcnew cli::array< System::Int32 >(4) {2, 0, 0, 0});
			this->numericUD_A->Minimum = System::Decimal(gcnew cli::array< System::Int32 >(4) {2, 0, 0, System::Int32::MinValue});
			this->numericUD_A->Name = L"numericUD_A";
			this->numericUD_A->Size = System::Drawing::Size(130, 20);
			this->numericUD_A->TabIndex = 11;
			this->numericUD_A->Value = System::Decimal(gcnew cli::array< System::Int32 >(4) {22, 0, 0, -2147352576});
			this->numericUD_A->ValueChanged += gcnew System::EventHandler(this, &Form1::numericUD_A_ValueChanged);
			// 
			// labelKoeff
			// 
			this->labelKoeff->AutoSize = true;
			this->labelKoeff->Location = System::Drawing::Point(16, 170);
			this->labelKoeff->Name = L"labelKoeff";
			this->labelKoeff->Size = System::Drawing::Size(81, 13);
			this->labelKoeff->TabIndex = 10;
			this->labelKoeff->Text = L"Parametrs (a, b)";
			this->labelKoeff->Click += gcnew System::EventHandler(this, &Form1::labelKoeff_Click);
			// 
			// comboBox1
			// 
			...
			this->comboBox1->Location = System::Drawing::Point(19, 228);
			...
			this->labelDist->Location = System::Drawing::Point(16, 113);
			...
			this->numericDist->Location = System::Drawing::Point(19, 134);
			...
			this->numericDist->Size = System::Drawing::Size(130, 20);
			...
			this->NumCentreY->Increment = System::Decimal(gcnew cli::array< System::Int32 >(4) {1, 0, 0, 983040});
			this->NumCentreY->Location = System::Drawing::Point(192, 81);
			...
			this->NumCentreY->Size = System::Drawing::Size(130, 20);
			...
			this->NumCentreX->Increment = System::Decimal(gcnew cli::array< System::Int32 >(4) {1, 0, 0, 983040});
			...
			this->NumCentreX->Size = System::Drawing::Size(130, 20);
			...
			this->ClientSize = System::Drawing::Size(1113, 754);
			this->Controls->Add(this->panel2);
			this->Controls->Add(this->panel1);
			this->Controls->Add(this->menuStrip1);
			this->MainMenuStrip = this->menuStrip1;
			this->Name = L"Form1";
			this->Text = L"JuliaSet";
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->numIters))->EndInit();
			this->panel2->ResumeLayout(false);
			this->panel2->PerformLayout();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->numericUD_B))->EndInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->numericUD_A))->EndInit();
...
private: System::Void buildJuliaSet(){
			 ...
			 for(int i = 0; i < width; i++) {
				 for(int j = 0; j < height; j++) {
					...
					//complex number z (with |z|>=2) isn't owned by the Julia Set
					...
					for(int k = 0; k < MaxIters; k++) {
						xNext = xCur*xCur - yCur*yCur + C.X;
						yNext = 2*xCur*yCur + C.Y;
...
private: System::Void labelKoeff_Click(System::Object^  sender, System::EventArgs^  e) {
		 }
private: System::Void numericUD_A_ValueChanged(System::Object^  sender, System::EventArgs^  e) {
			 C.X = Decimal::ToDouble(numericUD_A->Value);
		 }
private: System::Void numericUD_B_ValueChanged(System::Object^  sender, System::EventArgs^  e) {
			  C.Y = Decimal::ToDouble(numericUD_B->Value);
		 }
};
